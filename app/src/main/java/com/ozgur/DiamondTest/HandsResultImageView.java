...
public class HandsResultImageView extends AppCompatImageView {
  ...
  private static final int LEFT_HAND_CONNECTION_COLOR = Color.TRANSPARENT;
  private static final int RIGHT_HAND_CONNECTION_COLOR = Color.TRANSPARENT;
  private static final int CONNECTION_THICKNESS = 8; // Pixels
  private static final int LEFT_HAND_HOLLOW_CIRCLE_COLOR = Color.TRANSPARENT;
  private static final int RIGHT_HAND_HOLLOW_CIRCLE_COLOR = Color.TRANSPARENT;
